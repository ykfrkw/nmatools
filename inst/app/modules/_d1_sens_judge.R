...
# Note: the split-evidence p-value variant (judge_rob_direct_split_p) was
# removed — see commit message for the relevant turn. The overlap-aware
# sensitivity rule above is now the only "sens"-style judgement.
