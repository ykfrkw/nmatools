...
# Note: split-evidence p-value variant tests were removed alongside the
# helper itself. The overlap-aware sens variant above is the only
# remaining sensitivity rule.
